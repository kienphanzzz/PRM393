...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _updateTheme() {
    if (mounted) {
      setState(() {
        _isDarkTheme = ThemeController.isDark;
      });
    }
  }
  ...
  Future<void> _loadUserData() async {
    ...
    final String email = prefs.getString('user_email') ?? 'user@gmail.com';
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => GestureDetector(
                  onTap: () async {
                    ...
                    setState(() {
                      _profileImageIdx = index.toString();
                    });
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: _profileImageIdx == index.toString()
                            ? AppColors.primary
                            : Colors.transparent,
                        width: 3,
                      ),
      ...
      builder: (dialogContext) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                const int defaultFocus = 25;
                const int defaultShort = 5;
                const int defaultLong = 15;
                ...
                setState(() {
                  _focusTime = defaultFocus;
                  _shortBreak = defaultShort;
                  _longBreak = defaultLong;
                });
                ...
                ScaffoldMessenger.of(this.context).showSnackBar(
                  const SnackBar(
                    content: Text(
                      'Đã reset Pomodoro về mặc định 25 - 5 - 15',
                    ),
                    behavior: SnackBarBehavior.floating,
                  ),
                );
  ...
  Widget build(BuildContext context) {
    ...
    final int totalMins = HistoryStorage.historyList.fold(
      0,
    ...
    final Color cardBg = _isDarkTheme ? AppColors.cardBg : Colors.white;
                  ...
                  Row(
                    ...
                    children: AchievementProvider.getFeatured().isEmpty
                      ...
                      const Text(
                        ...
                        : AchievementProvider.getFeatured().map((a) {
                      return Column(
                        children: [
                          Text(
                            a.emoji,
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                      '$_focusTime - $_shortBreak - $_longBreak',
                      style: const TextStyle(
                        fontSize: 12,
                      ),
                    ),
